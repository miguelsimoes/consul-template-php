...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y -qq ca-certificates php7.0-bcmath php7.0-curl php7.0-cli php7.0-intl php7.0-json php7.0-mbstring php7.0-mcrypt php7.0-memcached php7.0-mysql php7.0-xmlrpc php7.0-xsl php7.0-dev php-pear unzip wget
#
